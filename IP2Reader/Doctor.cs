        ...
        private void loadGraph()
        {
            if (!(selected_session == null))
            {
                ...
                if (beginTijdBox.Text == ""
                    ...
                    || int.Parse(beginTijdBox.Text) < int.Parse(eindTijdBox.Text))
                {
                ...
                if (eindTijdBox.Text == ""
                    ...
                    || int.Parse(eindTijdBox.Text) > int.Parse(beginTijdBox.Text))
                {
                    eindTijdBox.Text = selected_session.session[selected_session.session.Count - 1].time.ToString();
                    eindPeriode = selected_session.session[selected_session.session.Count - 1].time;
                }
                else eindPeriode = int.Parse(eindTijdBox.Text);
